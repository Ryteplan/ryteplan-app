    ...
    async loadTableHeaders() {
      ...
      if (localStorage.getItem("tableHeaders")) {
        ...
        this.tableHeaders = [
          ...
          { title: 'Full Time Males', key: 'enUgFtMenN', minWidth: "140px", align: "end", show: false, sortable: false },
          { title: 'Full Time Females', key: 'enUgFtWmnN', minWidth: "140px", align: "end", show: false, sortable: false },
