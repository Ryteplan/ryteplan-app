    ...
    async loadTableHeaders() {
      ...
      if (localStorage.getItem("tableHeaders")) {
        ...
        this.tableHeaders = [
          ...
          { title: 'Fulltime Males', key: 'enUgFtMenN', minWidth: "140px", align: "end", show: false, sortable: false },
          { title: 'Fulltime Females', key: 'enUgFtWmnN', minWidth: "140px", align: "end", show: false, sortable: false },
